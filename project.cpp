...
bool ATM::withdraw() {
    ...
    while (withdrawalCount <= 3) {
        ...
        continueWithdrawal = globalinput_int(atm_list, bank_list, ui);
        ...
        if (startSelection == "1") {  // 은행 관리
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    cout << (ui.getLanguage() ? "Enter your card number (or '-1' to return): " : "카드 번호를 입력하세요 (0을 입력하면 돌아갑니다): ");
